...
const Breastplate = () => {
    return(
        ...
        <h1>The Breastplate of Saint Patrick:</h1>
            <ul>
                <li>a Prayer of Protection, traditionally attributed to Saint Patrick during his Irish ministry in the 5th century.</li>
